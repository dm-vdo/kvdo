 ...
 * 02110-1301, USA. 
 *
 * $Id: //eng/uds-releases/krusty/src/uds/masterIndex005.h#5 $
 */
 ...
 **/
int __must_check make_master_index005(const struct configuration *config,
 ...
 **/
int __must_check
compute_master_index_save_bytes005(const struct configuration *config,
				   size_t *num_bytes);
