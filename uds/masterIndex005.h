 ...
 * 02110-1301, USA. 
 *
 * $Id: //eng/uds-releases/krusty/src/uds/masterIndex005.h#3 $
 */
 ...
 **/
int __must_check makeMasterIndex005(const struct configuration *config,
 ...
 **/
int __must_check
computeMasterIndexSaveBytes005(const struct configuration *config,
                               size_t *numBytes);
