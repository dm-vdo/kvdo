 ...
 * 02110-1301, USA. 
 *
 * $Id: //eng/linux-vdo/src/c++/vdo/kernel/kernelTypes.h#10 $
 */
...
typedef void (*DataKVIOCallback)(struct data_kvio *dataKVIO);
typedef void (*KvdoWorkFunction)(struct kvdo_work_item *workItem);
