 ...
 * 02110-1301, USA. 
 *
 * $Id: //eng/linux-vdo/src/c++/vdo/base/adminCompletion.h#17 $
 */
 ...
 **/
typedef thread_id_t
thread_id_getter_for_phase(struct admin_completion *admin_completion);
...
struct admin_completion {
	...
	thread_id_getter_for_phase *get_thread_id;
