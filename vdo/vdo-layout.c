...
void vdo_free_layout(struct vdo_layout *vdo_layout)
{
	...
	vdo_free_copy_completion(UDS_FORGET(vdo_layout->copy_completion));
...
{
	vdo_copy_partition(layout->copy_completion,
			   vdo_get_partition(layout, id),
